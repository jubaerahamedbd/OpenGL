...
void spectra(float radius_x,float radius_y){
    int i=0;
    ...
    for (int i =0;i<10;i++){
        ...
        angle=2*i*3.1416/10;
        angle2 = (2*i*3.1416/10)+(3.1416/10);
        glVertex3f(cos(angle)*radius_x,sin(angle)*radius_y,0);
        glVertex3f(cos(angle2)*radius_x,sin(angle2)*radius_y,0);
        glVertex3f(cos(angle2+0.3)*radius_x,sin(angle2+0.3)*radius_y,0);
        glEnd();
    }
}
